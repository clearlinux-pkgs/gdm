...
Version  : 3.34.1
Release  : 77
URL      : https://download.gnome.org/sources/gdm/3.34/gdm-3.34.1.tar.xz
Source0  : https://download.gnome.org/sources/gdm/3.34/gdm-3.34.1.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570459816
