...
Source0  : https://download.gnome.org/sources/gdm/3.38/gdm-3.38.2.1.tar.xz
...
%prep
%setup -q -n gdm-3.38.2.1
cd %{_builddir}/gdm-3.38.2.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608236332
...
cp %{_builddir}/gdm-3.38.2.1/COPYING %{buildroot}/usr/share/package-licenses/gdm/4cc77b90af91e615a64ae04893fdffa7939db84c
