...
Version  : 3.22.3
Release  : 5
URL      : https://download.gnome.org/sources/gdm/3.22/gdm-3.22.3.tar.xz
Source0  : https://download.gnome.org/sources/gdm/3.22/gdm-3.22.3.tar.xz
...
%prep
%setup -q -n gdm-3.22.3

%build
export LANG=C
export SOURCE_DATE_EPOCH=1488828116
