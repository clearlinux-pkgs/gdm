...
Version  : 46.2
Release  : 111
URL      : https://download.gnome.org/sources/gdm/46/gdm-46.2.tar.xz
Source0  : https://download.gnome.org/sources/gdm/46/gdm-46.2.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717018136
unset LD_AS_NEEDED
