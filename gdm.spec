...
Version  : 3.36.2
Release  : 78
URL      : https://download.gnome.org/sources/gdm/3.36/gdm-3.36.2.tar.xz
Source0  : https://download.gnome.org/sources/gdm/3.36/gdm-3.36.2.tar.xz
...
Patch6: gdm3.service-wait-for-drm-device-before-trying-to-start-i.patch
...
%prep
%setup -q -n gdm-3.36.2
cd %{_builddir}/gdm-3.36.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590422288
...
cp %{_builddir}/gdm-3.36.2/COPYING %{buildroot}/usr/share/package-licenses/gdm/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
%find_lang gdm
