...
%prep
%setup -q -n gdm-3.38.0
cd %{_builddir}/gdm-3.38.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
cp %{_builddir}/gdm-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/gdm/4cc77b90af91e615a64ae04893fdffa7939db84c
